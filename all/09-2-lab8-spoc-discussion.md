...
完成代码填写，并形成spoc练习报告，需写练习报告和简单编码，完成后放到git server 对应的git repo中
 > 
 [代码](https://github.com/tengshuang/ucore_lab/tree/master/labcodes_answer/lab8_result)
 
 > 
 [输出结果](https://github.com/tengshuang/ucore_lab/blob/master/labcodes_answer/lab8_result/result.txt)
 ```
